...
if len(svmlist) == len(dtwlist):
  ...
  print 'intersection_list=' + str(combined_list)
  print 'union_list='+str(combined_list2)
  
  possibles = permutations(combined_list2);
  print 'possibilities='+str(len(possibles))
